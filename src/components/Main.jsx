...
const Main = () => {
    return (
        <div id={"main"} className={"relative"}>
            ...
            <img alt={"yeah"} className={"w-full max-h-screen object-cover"} src={"https://th.bing.com/th/id/R.b17cfaee30f9544e8ae1848ca8503ded?rik=QKW4hZbSn5Y4rg&pid=ImgRaw&r=0"}/>
